...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{{asset('assets/fonts/fontawesome-6.7.1/css/all.css')}}">
<!--===============================================================================================-->
		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->		
					<a href="#" class="logo">
						<img src="{{asset('assets/images/logo-01.png')}}" alt="IMG-LOGO">
					</a>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
                    ...
                    <ul class="sub-menu-m">
						<li><a href="/category">Homepage 1</a></li>
						<li><a href="/category">Homepage 2</a></li>
						<li><a href="/category">Homepage 3</a></li>
					</ul>
					<span class="arrow-main-menu-m">
						<i class="fa fa-angle-right" aria-hidden="true"></i>
					</span>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by developer</p>
			</div>
		</div>
	</footer>
